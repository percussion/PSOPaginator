/*
 * com.percussion.pso.paginator.finder PSORelationshipRevisionSlotFinder.java
 *  
 * @author DavidBenua
 *
 */
...
import com.percussion.services.assembly.impl.finder.PSRelationshipSlotFinder;
 ...
 *
 */
public class PSORelationshipRevisionSlotFinder extends PSRelationshipSlotFinder
      implements
         IPSSlotContentFinder
{
    ...
    */
   private static final Log log = LogFactory.getLog(PSORelationshipRevisionSlotFinder.class);

   /**
    * 
    */
   public PSORelationshipRevisionSlotFinder()
   {
      super();
   }

   /**
    * @see com.percussion.services.assembly.impl.finder.PSRelationshipSlotFinder#getSlotItems(com.percussion.services.assembly.IPSAssemblyItem, com.percussion.services.assembly.IPSTemplateSlot, java.util.Map)
    */
   @Override
   protected Set<SlotItem> getSlotItems(IPSAssemblyItem parentItem, IPSTemplateSlot slot, Map<String, Object> params) throws ItemNotFoundException
   {
      ...
      Set<SlotItem> results =  super.getSlotItems(parentItem, slot, params);
      try
      {
